  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.sectionMargin}>
        <Text style={[styles.sectionTitle, { color: colors.textTertiary }]}>АИ БАЛАНЫ ТАНУ</Text>
        <View style={[styles.aiBanner, { backgroundColor: isDark ? '#11221C' : '#E8F6F0' }]}>
          <View style={styles.aiBannerLeft}>
            ...
            <View>
              <Text style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: 16, fontWeight: '700', color: isDark ? '#FFFFFF' : '#1A1A1A', marginBottom: 4 }}>Айаруды табу</Text>
      ...
      {/* All cameras grid */}
      <View style={styles.sectionMargin}>
        <Text style={[styles.sectionTitle, { color: colors.textTertiary }]}>БАРЛЫҚ КАМЕРАЛАР</Text>
